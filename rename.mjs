...
async function setup() {
  ...
  const replacements = [
    // NPM package name
    ["@convex/reactions", npmPackageName],

    // Repository name
    ["get-convex/reactions", repoName],

    // Component name variations
    ["Reactions", cases.pascal],
    ["reactions", cases.camel],
    ["reactions", cases.kebab],
    ["reactions", cases.snake],
    ["reactions", cases.space],
    ["Reactions", cases.title],
  ];
  if (npmPackageName.includes("/")) {
    ...
    replacements.push(["@example%2Freactions", npmPackageName]);
  }
